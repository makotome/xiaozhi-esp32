...
void LightMcpController::RegisterMcpTools()
{
    ...
    mcp_server.AddTool(
        ...
        [](const PropertyList &properties) -> ReturnValue
        {
            ...
            controller->getLightController()->setLightMode(ColorfulLightController::MODE_NIGHT_LIGHT);
            return "夜灯已开启 💡";
        });
    ...
    mcp_server.AddTool(
        ...
        [](const PropertyList &properties) -> ReturnValue
        {
            ...
            controller->getLightController()->setLightMode(ColorfulLightController::MODE_DANCE_PARTY);
            return "跳舞派对灯光已开启 🎉";
        });
    ...
    mcp_server.AddTool(
        ...
        [](const PropertyList &properties) -> ReturnValue
        {
            ...
            controller->getLightController()->setLightMode(ColorfulLightController::MODE_BREATHING);
            return "呼吸灯效果已开启 🌙";
        });
    ...
    mcp_server.AddTool(
        ...
        [](const PropertyList &properties) -> ReturnValue
        {
            ...
            controller->getLightController()->setLightMode(ColorfulLightController::MODE_RAINBOW);
            return "彩虹灯光已开启 🌈";
        });
    ...
    mcp_server.AddTool(
        ...
        [](const PropertyList &properties) -> ReturnValue
        {
            ...
            controller->getLightController()->setLightMode(ColorfulLightController::MODE_FLASH);
            return "闪烁灯光已开启 ⚡";
        });
    ...
    mcp_server.AddTool(
        ...
        [](const PropertyList &properties) -> ReturnValue
        {
            ...
            controller->getLightController()->setLightMode(ColorfulLightController::MODE_WARM_LIGHT);
            return "暖光模式已开启 ☀️";
        });
    ...
    mcp_server.AddTool(
        ...
        [](const PropertyList &properties) -> ReturnValue
        {
            ...
            controller->getLightController()->setLightMode(ColorfulLightController::MODE_COOL_LIGHT);
            return "冷光模式已开启 ❄️";
        });
    ...
    mcp_server.AddTool(
        ...
        [](const PropertyList &properties) -> ReturnValue
        {
            ...
            int mode = static_cast<int>(controller->getLightController()->getCurrentMode());
            int brightness = controller->getLightController()->getBrightness();

            const char *mode_names[] = {
                "关闭", "夜灯", "跳舞派对", "呼吸灯", "彩虹渐变", "闪烁", "暖光", "冷光"};
